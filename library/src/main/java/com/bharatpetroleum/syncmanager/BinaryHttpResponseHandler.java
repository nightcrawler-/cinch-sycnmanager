...
/**
 * Used to intercept and handle the responses from requests made using {@link AsyncHttpClient}. Receives response body
 * as byte array with a content-type whitelist. (e.g. checks Content-Type against allowed list, Content-length).
 * <p>
 * For example:
 * <p>
 * 
...
public class BinaryHttpResponseHandler extends AsyncHttpResponseHandler {
	...
	/**
	 * Creates a new BinaryHttpResponseHandler, and overrides the default allowed content types with passed String array
